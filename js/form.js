...
(function () {
  ...
  window.form = {
    onNumberSelectChange: function () { // Устанавливаем соответствие количества комнат количеству гостей
    ...
    mapFiltersSelectDisabled: function () { // Делает неактивными поля формы на карте в неактивном режиме
  ...
  window.form.mapFiltersSelectDisabled();
  ...
  roomNumber.addEventListener('change', window.form.onNumberSelectChange); // Устанавливаем соответствие количества комнат количеству гостей
  window.form.onNumberSelectChange();
})();
